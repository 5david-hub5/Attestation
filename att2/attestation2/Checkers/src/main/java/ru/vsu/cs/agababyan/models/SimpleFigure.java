...
import ru.vsu.cs.agababyan.models.KingFigure;



@JsonClassDescription("SimpleFigure")
public class SimpleFigure extends Figure {

    private static final Logger log = LoggerFactory.getLogger(SimpleFigure.class);
